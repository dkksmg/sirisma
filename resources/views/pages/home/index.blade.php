    ...
    <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            ...
            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                ...
                <a class="me-3 py-2 text-dark text-decoration-none" href="#">Kontak</a>
                @auth()
                <a class="me-3 py-2 text-dark text-decoration-none" href="#">Permohonan</a>
                @endauth
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mt-3 mb-1" style="font-size: 16px">Rp. 40.000 - Rp. 400.000 per minggu</p>
