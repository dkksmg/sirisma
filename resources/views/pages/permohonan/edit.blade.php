    ...
    <div class="row justify-content-md-start">
      <div class="col-md-12">
        <div class="container px-5 my-5">
          <form action="{{ route('permohonan.update', $app->kode_permohonan) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <input class="form-control @error('nama_pemohon') is-invalid @enderror" id="nama" type="text" placeholder="Nama" name="nama_pemohon" readonly disabled <?php if(isset(Auth::user()->name)):?> value="{{ Auth::user()->name }}" <?php else: ?> value="{{ old('nama_pemohon') }}" <?php endif ?> />
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <textarea class="form-control @error('keperluan_pemohon') is-invalid @enderror" id="keperluan_pemohon" name="keperluan_pemohon" type="text" placeholder="Keperluan Permohon" style="height: 8rem">
...
@endif
              ...
              <div class="col-md-6">
                <div class="form-floating mb-3">
                  <textarea class="form-control @error('judul_penelitian') is-invalid @enderror" id="judul_penelitian" name="judul_penelitian" type="text" placeholder="Judul Rencana Penelitian" style="height: 8rem" data-sb-validations="required">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group mb-3 ">
                  ...
                  <input type="text" class="form-control @error('waktu_awal') is-invalid @enderror" id="datepicker-one" placeholder="Waktu Awal Penelitian" name="waktu_awal" @if (!empty($app->waktu_awal)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $app->waktu_awal)->format('d/m/Y') }}"
                  @else
              ...
              <div class="col-md-6">
                <div class="form-group mb-3 ">
                  ...
                  <input type="text" class="form-control @error('waktu_akhir') is-invalid @enderror" id="datepicker-two" placeholder="Waktu Akhir Penelitian" name="waktu_akhir" @if (!empty($app->waktu_akhir)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $app->waktu_akhir)->format('d/m/Y') }}"
                  @else
