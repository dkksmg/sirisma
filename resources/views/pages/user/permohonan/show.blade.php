                    ...
                    <div class="col-md-12">
                        <div class="container px-5 my-5">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table" id="example"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="text-justify">Nama Lengkap</th>
                                                    <th class="text-justify">NIM/NIP</th>
                            ...
                            <div class="card mt-3 mb-5">
                                <div class="card-header text-left">
                                    <div class="">
                                        <h6><strong>Data Permohonan</strong></h6>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3 mt-2">
                                                <input class="form-control id="no_surat" type="text"
                                                    placeholder="Nomor Surat" name="no_surat" value="{{ $data->no_surat }}"
                                                    disabled readonly />
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3 mt-2">
                                                <input class="form-control" id="asal_surat" type="text"
                                                    placeholder="Asal Surat" name="asal_surat"
                                                    value="{{ $data->asal_surat }}" disabled readonly />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" wire:key="UNIQUE_KEY">
                                            <div class="form-group mb-3 mt-2" wire:ignore>
                                                ...
                                                <select id="lokasi"
                                                    class="js-example-basic-multiple js-states form-select "
                                        ...
                                        <div class="col-md-6" wire:key="UNIQUE_KEY">
                                            <div class="form-group mb-3 mt-2" wire:ignore>
                                                <label for="datepicker-three" class="form-label">Tanggal Surat
                                                    Permohonan</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6" wire:key="UNIQUE_KEY">
                                            <div class="form-group mb-3 mt-2" wire:ignore>
                                                <label for="datepicker-one" class="form-label ">Tanggal Pelaksanaan
                                                    Mulai</label>
                                        ...
                                        <div class="col-md-6" wire:key="UNIQUE_KEY">
                                            <div class="form-group mb-3 mt-2" wire:ignore>
                                                <label for="datepicker-two" class="form-label ">Tanggal Pelaksanaan Akhir
                                                </label>
                                                <input type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating-mb 3">
                                                ...
                                                <object data="{{ url(Storage::url($data->file_surat_pemohon)) }}"
                                                    ...
                                                    style="min-height:50vh;min-width:20vw">
