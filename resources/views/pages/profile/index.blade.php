            ...
            <div class="card-body p-0">
              <ul class="list-group list-group-flush rounded-3">
                <li class="list-group-item d-flex justify-content-center align-items-center p-3">
                  <p>Foto KTP</p>
                  <img src="{{ Storage::url($data->file_ktp) }}" alt="foto-ktp" class="img-fluid img-thumbnail rounded mx-auto d-block" width="50%" height="50%" data-bs-toggle="modal" data-bs-target="#imgKTP" onerror="this.onerror=null; this.src='{{ url('assets/img/no-photo.png') }}'">
                </li>
                <li class="list-group-item d-flex justify-content-center align-items-center p-3">
                  <p>Foto KTM</p>
                  <img src="{{ Storage::url($data->file_ktm) }}" alt="foto-ktm" class="img-fluid img-thumbnail rounded mx-auto d-block" width="50%" height="50%" data-bs-toggle="modal" data-bs-target="#imgKTM" onerror="this.onerror=null; this.src='{{ url('assets/img/no-photo.png') }}'" />
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="{{ Storage::url($data->file_ktp) }}" alt="foto-ktp" class="img-fluid img-thumbnail rounded mx-auto d-block" width="auto" height="auto" onerror="this.onerror=null; this.src='{{ url('assets/img/no-photo.png') }}'">
        </div>
  ...
  <div class="modal fade" id="imgKTM" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <img src="{{ Storage::url($data->file_ktm) }}" alt="foto-ktm" class="img-fluid img-thumbnail rounded mx-auto d-block" width="auto" height="auto" onerror="this.onerror=null; this.src='{{ url('assets/img/no-photo.png') }}'">
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        </div>
...
<!-- Modal -->
<div class="modal fade" id="fotoModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="{{ route('imageprofile', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="modal-body">
          <img @if (empty($data->user->foto_profile)) src="{{ url('assets/img/man.png') }}"
          ...
          <div class="input-group mb-3 mt-4">
            ...
            <input type="text" class="form-control @error('nama_pengguna') is-invalid @enderror" aria-describedby="basic-addon1" name="nama_pengguna" @if (!empty(Auth::user()->name)) value="{{ Auth::user()->name }}"
            @else
          ...
          <div class="input-group mb-3 mt-4">
            ...
            <input type="text" class="form-control @error('email') is-invalid @enderror" aria-label="Email" aria-describedby="basic-addon1" name="email" @if (!empty(Auth::user()->email)) value="{{ Auth::user()->email }}"
            @else
          ...
          <div class="input-group mb-3">
            ...
            <input type="file" class="form-control @error('imageprofile') is-invalid @enderror" name="imageprofile" id="inputGroupFile01">
            @error('imageprofile')
            <div class="invalid-feedback" role="alert">{{ $message }}</div>
            @enderror
          </div>
