<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
    ...
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('kasi.dashboard') }}">
    ...
    <ul class="navbar-nav align-items-center ms-auto">
            ...
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                ...
                @foreach ($penelitianBaru as $penelitian)
                    <a class="dropdown-item dropdown-notifications-item"
                        href="{{ route('kasi.penelitian-baru') }}#permohonan{{ $penelitian->id_application }}">
                ...
                @endforeach
                <a class="dropdown-item dropdown-notifications-footer" href="{{ route('kasi.penelitian-baru') }}">View
                    All Alerts</a>
            </div>
        </li>
        <!-- Messages Dropdown-->
        ...
        <li class="nav-item dropdown no-caret dropdown-user me-3 mx-5 me-lg-4">
            ...
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                ...
                <a class="dropdown-item" href="{{ route('kasi.profile') }}">
