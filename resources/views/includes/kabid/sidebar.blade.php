            ...
            <div class="nav accordion" id="accordionSidenav">
                ...
                <a class="nav-link" href="{{ route('kabid.penelitian-baru') }}">
                    ...
                    @if ($penelitianBaruSidebar != 0)
                        <span
                            class="badge bg-danger-soft text-danger ms-auto animate__animated animate__swing animate__infinite infinite animate__animated animate__swing animate__infinite infinite">
