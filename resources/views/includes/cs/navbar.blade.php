<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
    ...
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="{{ route('cs.dashboard') }}">
    ...
    <ul class="navbar-nav align-items-center ms-auto">
            ...
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                ...
                @foreach ($penelitianBaru as $penelitian)
                    <a class="dropdown-item dropdown-notifications-item"
                        href="{{ route('cs.penelitian-baru') }}#permohonan{{ $penelitian->id_application }}">
                ...
                @endforeach
                <a class="dropdown-item dropdown-notifications-footer" href="{{ route('cs.penelitian-baru') }}">View All
                    Alerts</a>
            </div>
        </li>
        <!-- Messages Dropdown-->
        ...
        <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
            ...
            <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                ...
                <a class="dropdown-item" href="{{ route('cs.profile') }}">
