...
class ProcessedApplicationKabidController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $penelitianProses = DB::table('applications as one')
            ...
            ->orwhere(['two.status_surat' => 'tolak', 'two.role' => 'KABID'])
            ->whereNull('one.deleted_at')
        ...
        $penelitianBaru = DB::table('applications as one')
            ...
            ->get();
        return view(
            'pages.kabid.permohonan.terproses.list',
            [
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('penelitian-terproses-kabid.index')->with(['success' => 'Permohonan Terproses!']);
        }
    }
