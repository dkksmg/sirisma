...
class ProfileKabidController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $penelitianProses = DB::table('applications as one')
            ...
            ->whereNull('one.deleted_at')
            ->count();
        return view('pages.kabid.profile.index', [
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            // dd($data);
            $item->update($data);
            return redirect()->route('profile-kabid.index')->withSuccess('Akun Profile diupdate!');
        }
    }
    /**
