...
class ProcessedApplicationKasiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $penelitianBaru = DB::table('applications as one')
            ...
            ->get();
        return view(
            'pages.kasi.permohonan.terproses.list',
            [
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('penelitian-terproses-kasi.index')->with(['success' => 'Permohonan Terproses!']);
        }
    }
